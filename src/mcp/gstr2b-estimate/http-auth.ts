/**
 * Bearer-token auth for the networked Estimated GSTR-2B endpoint. Mirror of the other MCPs'
 * http-auth.ts with the GSTR2B_EST_MCP_TOKEN_<USER> prefix.
 *
 * Each user gets their own secret in `.env` as GSTR2B_EST_MCP_TOKEN_<USER> (e.g. ..._JP, ..._FIDA).
...
const PREFIX = "GSTR2B_EST_MCP_TOKEN_";
