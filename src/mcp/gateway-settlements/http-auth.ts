/**
 * Bearer-token auth for the networked Gateway Settlements endpoint. Mirror of Hima/Only Care's
 * http-auth.ts with the GATEWAY_MCP_TOKEN_<USER> prefix.
 *
 * Each user gets their own secret in `.env` as GATEWAY_MCP_TOKEN_<USER> (e.g. ..._JP, ..._FIDA).
...
const PREFIX = "GATEWAY_MCP_TOKEN_";
