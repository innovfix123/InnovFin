/**
 * OAuth discovery documents for the Google Drive resource (RFC 8414 AS metadata, RFC 9728 PR
 * metadata). Mirrors gateway's oauth/metadata.ts off the DRIVE config, so `issuer` is the path-based
