/**
 * Bearer-token auth for the networked Google Drive endpoint. Mirror of gateway-settlements/http-auth.ts
 * with the DRIVE_MCP_TOKEN_<USER> prefix.
 *
 * Each user gets their own secret in `.env` as DRIVE_MCP_TOKEN_<USER> (e.g. ..._JP, ..._FIDA).
