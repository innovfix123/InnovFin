/**
 * OAuth discovery documents for the invoice-intelligence resource (RFC 8414 AS metadata, RFC 9728 PR
 * metadata). Mirrors Hima's oauth/metadata.ts but off this config, so `issuer` is the path-based
