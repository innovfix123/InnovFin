/**
 * OAuth discovery documents for the Hima resource (RFC 8414 AS metadata, RFC 9728 PR metadata).
 * Mirrors Only Care's oauth/metadata.ts but off the HIMA config, so `issuer` is the path-based
