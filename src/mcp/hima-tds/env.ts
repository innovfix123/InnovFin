...
/** Repo root, derived from this module's location (src/mcp/hima-tds → ../../..). */
 ...
 * (Mirrors src/mcp/onlycare-tds/env.ts — a candidate to lift into a shared module later.)
 */
 ...
 * Used to discover per-user MCP tokens (HIMA_MCP_TOKEN_<USER>) without a hardcoded user list
 * when the networked endpoint lands.
 */
