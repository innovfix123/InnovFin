/**
 * Bearer-token auth for the networked Hima TDS endpoint. Mirror of Only Care's http-auth.ts with
 * the HIMA_MCP_TOKEN_<USER> prefix.
 *
 * Each user gets their own secret in `.env` as HIMA_MCP_TOKEN_<USER> (e.g. ..._JP, ..._FIDA).
