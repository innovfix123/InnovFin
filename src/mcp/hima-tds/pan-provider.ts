 ...
 * rate and flags "unverified".
 *
 * (Verbatim mirror of src/mcp/onlycare-tds/pan-provider.ts — fully app-agnostic; a candidate to
 * lift into a shared module so both apps import one copy.)
 */
