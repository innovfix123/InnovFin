/**
 * Token endpoint for the TDS Working resource. Mirror of Gateway Settlements', off the TDS_WORKING
...
import { issueTokens, claimCode } from "@/mcp/tds-working/oauth/grants";
import { isMcpAllowed, resource } from "@/mcp/tds-working/oauth/config";
