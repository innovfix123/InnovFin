/**
 * Dynamic Client Registration endpoint (RFC 7591). Public PKCE clients only (no secret issued).
 * Returns 201 with a stateless client_id that encodes the registered redirect_uris.
 */
