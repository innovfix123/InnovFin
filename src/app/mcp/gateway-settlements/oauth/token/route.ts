/**
 * Token endpoint for the Gateway Settlements resource. Mirror of Hima's, off the GATEWAY config/grants
 * so the minted access token's audience = this resource. Reuses the shared (resource-agnostic) JWT
...
import { issueTokens, claimCode } from "@/mcp/gateway-settlements/oauth/grants";
import { isMcpAllowed, resource } from "@/mcp/gateway-settlements/oauth/config";
