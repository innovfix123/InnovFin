...
const AUTOMATIONS: Automation[] = [
  ...
  },
  {
    ...
    status: "live",
    href: "/invoices",
    cta: "Open invoice inbox",
    description:
      "Every invoice emailed to the company is captured, read (GSTIN, number, date, total) and de-duplicated. Review the flagged ones — approve, correct or reject — in one queue.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.6} strokeLinecap="round" strokeLinejoin="round">
